...
const img = new Image();
const imagePath = 'fire.jpg'; // Replace with your image path
                ...
                for (let x = 0; x < img.width; x += pixelSize) {
                    ...
                    for (let dy = 0; dy < pixelSize; dy++) {
                        for (let dx = 0; dx < pixelSize; dx++) {
                            const pxIndex = (x + dx + (y + dy) * img.width) * 4;
                            const withinImageBounds = x + dx < img.width && y + dy < img.height;
                            const isNotTransparent = data[pxIndex + 3] !== 0;

                            if (withinImageBounds && isNotTransparent) {
                                red += data[pxIndex];
                    ...
                    if (count > 0) {
                        ...
                        arr.push(convertToRGB(`${avgRed},${avgGreen},${avgBlue},${(avgAlpha/255)}`))
                    } else {
